...
class _EditarUsuarioInfoState extends State<EditarUsuarioInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    void actualizarDatosUsuario(var usuario) {
      print(usuario);
                ...
                child: Column(
                  children: [
                    Container(
                      child: TextFormField(
                        decoration: TemasAyuda()
                            .textInputDecoracion("Nombre", "Ingrese su nombre"),
                    ...
                    Container(
                      child: TextFormField(
                        decoration: TemasAyuda()
                            .textInputDecoracion("E-mail", "Ingrese su e-mail"),
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          actualizarDatosUsuario(usuarioProvider.currentUser["usuario"]);
